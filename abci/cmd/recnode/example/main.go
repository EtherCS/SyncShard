...
import (
	...
	recapp "github.com/EtherCS/SyncShard/abci/rec_state/recabci"
	recst "github.com/EtherCS/SyncShard/abci/rec_state/recovery"
)
...
func main() {
	...
	db := recst.NewRecoveryState("leveldb", dbPath)
	defer func() {
		if err := db.KVdb.Close(); err != nil {
			log.Fatalf("Closing database: %v", err)
		}
	}()
	app := recapp.NewRecoveryApplication(db)
	// app := kvs.NewApplication()
